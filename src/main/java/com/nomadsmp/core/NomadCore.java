...
import com.nomadsmp.core.config.ConfigMigrator;
import com.nomadsmp.core.listeners.*;
import com.nomadsmp.core.modules.*;
import com.nomadsmp.core.utils.DependencyDownloader;
...
public class NomadCore extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Migrate: add new keys from JAR defaults into existing user config
    ...
    public void reload() {
        // Re-migrate in case defaults changed
        ConfigMigrator migrator = new ConfigMigrator(this);
        migrator.migrate();
    ...
    public DependencyDownloader getDependencyDownloader() { return dependencyDownloader; }
